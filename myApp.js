...
var createAndSavePerson = function(done) {
  var sriramSharma = new Person({
    name: "Sriram Sharma",
    age: 41,
    favouriteFoods: ["pizza", "beer"]
  });

  sriramSharma.save(function(err, data) {
...
let arrayOfPeople = [
  { name: "Rohit", age: 33, favouriteFoods: ["pizza", "beer"] },
  { name: "Sriram", age: 41, favouriteFoods: ["burger", "wine"] },
  { name: "Anushka", age: 32, favouriteFoods: ["tacos", "lemonade"] }
];
...
// direcly calls the mongodb driver.l
...
var removeById = function(personId, done) {
  Person.findByIdAndRemove(personId, (err, delrec) => {
    if (err) {
      console.log(err);
    } else {
      done(null, delrec);
